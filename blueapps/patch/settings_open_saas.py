...
if is_open_saas_v2():  # V2
    ...
    BK_COMPONENT_API_URL = BK_PAAS_INNER_HOST = os.getenv("BK_PAAS_INNER_HOST", BK_PAAS_HOST).rstrip("/")
    ...
    BK_COMPONENT_API_URL = os.getenv("BK_COMPONENT_API_URL", BK_PAAS_INNER_HOST)

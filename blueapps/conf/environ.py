...
# PaaS 主版本号, PaaS3.0 开始引入新的环境变量 BKPAAS_MAJOR_VERSION 描述当前平台的主版本号, 作为 fallback, 使用 BK_ENV 来判断 V2 环境
BKPAAS_MAJOR_VERSION = int(os.environ.get("BKPAAS_MAJOR_VERSION", 2 if "BK_ENV" in os.environ else -1))

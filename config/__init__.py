...
# 应用 ID
APP_ID = APP_CODE = os.getenv("APP_ID", "open-api")
# 应用用于调用云 API 的 Secret
APP_TOKEN = SECRET_KEY = os.getenv("APP_TOKEN", "f9f90e56-5ecc-4a47-9442-a55790a055dd")

# SaaS运行版本，如非必要请勿修改
RUN_VER = "open"
# 蓝鲸SaaS平台URL，例如 http://paas.bking.com
BK_PAAS_HOST = os.getenv("BK_PAAS_HOST", "http://paas.dev.com:80/t/open-api/")
